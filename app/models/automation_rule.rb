...
class AutomationRule < ApplicationRecord
  ...
  ACTIONS_ATTRS = %w[send_message add_label add_label_to_contact send_email_to_team assign_team assign_agent send_webhook_event mute_conversation send_attachment
